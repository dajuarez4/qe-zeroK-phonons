...
- Latest complete-frame temperature: 326.035 K
...
- Force equations: 93,360
- First- plus second-order parameters: 1,125
- Overdetermination ratio: 83.0
- Harmonic force-fit residual RMS: 0.324 eV/Angstrom
- Force residual R-squared: 0.905
- TDEP anharmonicity measure: 0.308
- Frequency range: -1.498 to 25.903 THz

This is a pipeline diagnostic, not a converged finite-temperature phonon
spectrum. This separate `nraise=20` run has 389 adjacent complete MD frames
covering 376.4 fs. The full trajectory retains the initial cooling transient
but now averages 279 K, with recent frames fluctuating around and above 300 K.
...
0.149 eV/Angstrom. This snapshot predates the current 389-frame fit, so it does
