#!/usr/bin/env python3
"""Build FM QE force inputs from the common displaced supercells."""

from pathlib import Path
import re

ROOT = Path(__file__).resolve().parent
HEADER = "&CONTROL\n  calculation = 'scf'\n  prefix      = 'alpha-Fe2O3-BMeq-FM-fd'\n  outdir      = './tmp'\n  pseudo_dir  = '../../../../pseudo'\n  verbosity   = 'high'\n  tstress     = .true.\n  tprnfor     = .true.\n  disk_io     = 'low'\n/\n\n&SYSTEM\n  ibrav             = 0\n  nat               = 80\n  ntyp              = 3\n  input_dft         = 'PBE'\n  ecutwfc           = 80\n  ecutrho           = 640\n  occupations       = 'fixed'\n  nspin             = 2\n  tot_magnetization = 160.0\n  starting_magnetization(2) =  0.80\n  starting_magnetization(3) =  0.80\n  lda_plus_u        = .true.\n  Hubbard_U(2)      = 4.0\n  Hubbard_U(3)      = 4.0\n  U_projection_type = 'ortho-atomic'\n  nosym             = .true.\n  noinv             = .true.\n/\n\n&ELECTRONS\n  electron_maxstep = 400\n  conv_thr         = 1.0d-12\n  mixing_beta      = 0.10\n  mixing_mode      = 'local-TF'\n  mixing_ndim      = 12\n  diagonalization  = 'david'\n/\n"
K_POINTS = "\nK_POINTS automatic\n4 4 4 0 0 0\n"
...
print(f"Prepared {len(sources)} FM displacement inputs")
