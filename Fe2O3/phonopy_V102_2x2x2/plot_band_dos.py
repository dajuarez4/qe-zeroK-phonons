#!/usr/bin/env python3
"""Plot the V102 phonon dispersion and total DOS in the V100 layout."""
...
fig.suptitle(r"Fe$_2$O$_3$ V102 phonons (2$\times$2$\times$2)")
fig.subplots_adjust(top=0.84, bottom=0.16, left=0.12, right=0.98)
fig.savefig(ROOT / "Fe2O3_V102_phonon_band_dos.pdf")
