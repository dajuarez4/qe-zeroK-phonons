#!/usr/bin/env python3
"""Overlay V100, V102, V104, and V106 phonon bands and total DOS."""
...
CASES = {
    ...
    "V106*": (ROOT / "phonopy_V106_2x2x2", "#2ca02c"),
}
...
fig.suptitle(
    r"Fe$_2$O$_3$ phonons: V100, V102, V104, and V106 (2$\times$2$\times$2)"
)
fig.text(
    0.5,
    0.025,
    "* V106 uses the documented harmonic reconstruction of displacement 003.",
    ha="center",
    fontsize=8,
)
fig.subplots_adjust(top=0.85, bottom=0.18, left=0.10, right=0.98)
fig.savefig(ROOT / "Fe2O3_V100_V102_V104_V106_phonon_comparison.pdf")
fig.savefig(ROOT / "Fe2O3_V100_V102_V104_V106_phonon_comparison.png", dpi=220)
