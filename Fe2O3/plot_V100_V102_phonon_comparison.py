#!/usr/bin/env python3
"""Overlay the V100 and V102 phonon bands and total densities of states."""
...
def load_case(directory):
    ...
    data["dos"] = np.loadtxt(directory / "total_dos.dat")
    return data
...
fig, axes = plt.subplots(
    ...
    figsize=(7.2, 5.0),
    sharey=True,
    gridspec_kw={"width_ratios": [*widths, max(widths) * 0.75], "wspace": 0.12},
)
...
fig.suptitle(r"Fe$_2$O$_3$ phonons: V100 vs V102 (2$\times$2$\times$2)")
fig.subplots_adjust(top=0.85, bottom=0.16, left=0.10, right=0.98)
fig.savefig(ROOT / "Fe2O3_V100_V102_phonon_comparison.pdf")
fig.savefig(ROOT / "Fe2O3_V100_V102_phonon_comparison.png", dpi=220)
