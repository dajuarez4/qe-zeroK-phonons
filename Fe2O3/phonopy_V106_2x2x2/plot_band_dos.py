#!/usr/bin/env python3
"""Plot the V106 phonon dispersion and total DOS."""
...
widths = [distances[group[-1], -1] - distances[group[0], 0] for group in GROUPS]
...
fig.suptitle(
    r"Fe$_2$O$_3$ V106 phonons (2$\times$2$\times$2; reconstructed disp-003)"
)
fig.subplots_adjust(top=0.84, bottom=0.16, left=0.12, right=0.98)
fig.savefig(ROOT / "Fe2O3_V106_phonon_band_dos.pdf")
