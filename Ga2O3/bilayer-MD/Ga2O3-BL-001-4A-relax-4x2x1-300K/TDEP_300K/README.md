...
- Latest complete-frame temperature: 268.314 K
...
- Force equations: 33,360
- First- plus second-order parameters: 171
- Overdetermination ratio: 195.1
- Harmonic force-fit residual RMS: 0.598 eV/Angstrom
- Force residual R-squared: 0.599
- TDEP anharmonicity measure: 0.633
- Frequency range: -3.181 to 21.395 THz

This is a pipeline diagnostic, not a converged finite-temperature phonon
spectrum. This separate `nraise=20` run has 139 adjacent complete MD frames
covering 134.5 fs. The full trajectory retains the initial cooling transient
and averages 233 K despite later intervals closer to 300 K. The negative
...
is the previously generated 81-frame cumulative snapshot. The
normalized residual
